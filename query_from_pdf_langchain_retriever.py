...
overview_template = """{market}의 정의, 원리, 종류, 타 기술과의 특징 비교 등을 한글 500자 분량으로 작성해줘.
...
# 시장 분석 시작
for name, template in contents.items() : #[overview_template, trend_template, characteristic_template, size_template, company_template, factor_template] :
