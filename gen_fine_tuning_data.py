...
question = "generate ten pairs of question and answers from following text and give me answers as following structure :{\"prompt\": question, \"completion\": answer}: "

ko_context = """양자 암호화 상업화는 고객 인식 부족으로 어려움이 있으며, 지식은 경제 성장의 주요 동력 중 하나입니다. 
...
messages = [
    {"role": "system", "content": "You are a industrial market expert. You have to give specialied and detailed answers. Always anaswer in Korean."},
